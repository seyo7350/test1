...
public class productDTO {
	...
	private int product_photo_detail_count;
	...
	public productDTO(int product_seq, String product_name, int product_price, int product_point,
			int product_option_count, String product_info_about, String product_info_detail,
			String product_info_size_tip, String product_info_washing_tip, String product_photo_gif,
			String product_photo_main, String product_photo_detail_main, int product_photo_detail_count,
		...
		this.product_info_detail = product_info_detail;
		...
		this.product_photo_detail_count = product_photo_detail_count;
	...
	public void setProduct_info_detail(String product_info_detail) {
		this.product_info_detail = product_info_detail;
	}
	...
	public int getProduct_photo_detail_count() {
		return product_photo_detail_count;
	}
	public void setProduct_photo_detail_count(int product_photo_detail_count) {
		this.product_photo_detail_count = product_photo_detail_count;
	}
	...
	public String toString() {
		return "productDTO [product_seq=" + product_seq + ", product_name=" + product_name + ", product_price="
				...
				+ ", product_info_about=" + product_info_about + ", product_info_detail=" + product_info_detail
				...
				+ ", product_photo_detail_count=" + product_photo_detail_count + ", product_style_code="
				+ product_style_code + ", product_regiDate=" + product_regiDate + ", product_del=" + product_del + "]";
	}
}

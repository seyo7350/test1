...
System.out.println(strMemberSeq);
System.out.println(strProductSeq);
System.out.println(strProductOptionSeq);
...
<h2>리뷰 작성 하기</h2>
							...
							<form action="reviewWriteAf.jsp?memberSeq=<%=strMemberSeq %>&productSeq=<%=strProductSeq %>&productOptionSeq=<%=strProductOptionSeq %>&reviewId=<%=reviewId %>" method="post" id="frm" enctype="multipart/form-data">
                                <table summary="">
                                    ...
                                    <tbody>
                                    	 <tr>
                                            <th><div>작성자</div></th>
                                            <td class="info"><div><input id='bw_input_writer' type='text' name='hname'  class="MS_input_txt input_style" value="<%=reviewId %>" readonly="readonly" /></div></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="info">
                                                <div>
                                                 <input type="file" name="forReviewImage">
                                                 </div>   
                                            </td>
                                        </tr>
										                                                                                <tr>

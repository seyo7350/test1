...
String s_qna_num = request.getParameter("seq").trim();

int qnaanswer_qna_num = Integer.parseInt(s_qna_num);

QnADAO qDAO = new QnADAO();
QnADTO qDTO = qDAO.qnaDetail(s_qna_num);

System.out.println("dfdfdfd" + s_qna_num);
%>
...
<div id="content">
	<div class="page_title_area">
	    ...
	    <dl class="prd-tinfo">
                            ...
                            <dd>
                                <ul>
                                    <li class="name"><span class="tit">상 품 명:</span><a href="/shop/shopdetail.html?branduid=29890&xcode=002&mcode=003&scode=&GfDT=bmt4W1w%3D">love some, ops</a>
                         ...
                         <div class="bbs-table-view">
                            <table summary="게시글 보기">
                               <!--  <caption>게시글 보기</caption> -->
                                <thead>
                                    <tr>
                                        <th class="subject"><div class="tb-left">[<%=qDTO.getQna_subhead() %>] <%=qDTO.getQna_title() %></div></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="border-bottom: 1px solid lightgray;">
                                        <td class="line">
                                            <div class="cont-sub-des">
                                                <div>
                                                    <span><em>작성일 :</em> <%=qDTO.getQna_writeday() %></span>                                                </div>
                                                    
                                                <div>
                                                    <span><em>작성자 :</em> <%=qDTO.getQna_author() %></span>
                                                                                                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="data-bd-cont">
                                                                                                <div id=MS_WritenBySEB><%=qDTO.getQna_content() %></div>                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>

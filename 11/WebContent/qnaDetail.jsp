...
<div id="content">
	<div class="page_title_area">
	    ...
	    <dl class="prd-tinfo">
                            ...
                            <dd>
                                <ul>
                                    <li class="name"><span class="tit">상 품 명:</span><a href="/shop/shopdetail.html?branduid=29890&xcode=002&mcode=003&scode=&GfDT=bmt4W1w%3D">love some, ops</a> <span class='MK-product-icons'><img src='/shopimages/cherry07/prod_icons/160' class='MK-product-icon-3' /><img src='/shopimages/cherry07/prod_icons/53' class='MK-product-icon-4' /></span><!--/coupon_icon/--></li>
                                    <li class="price"><span class="tit">상품가격:</span><strong>32,000원</strong></li>
                                </ul>
                            </dd>
                        </dl>
                         ...
                         <div class="bbs-table-view">
                            <table summary="게시글 보기">
                               <!--  <caption>게시글 보기</caption> -->
                                <thead>
                                    <tr>
                                        <th class="subject"><div class="tb-left">[${detail.qna_subhead }] ${detail.qna_title }</div></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="line">
                                            <div class="cont-sub-des">
                                                <div>
                                                    <span><em>작성일 :</em> ${detail.qna_writeday }</span>                                                </div>
                                                    
                                                <div>
                                                    <span><em>작성자 :</em> ${detail.qna_author }</span>
                                                                                                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="data-bd-cont">
                                                                                                <div id=MS_WritenBySEB>${detail.qna_title }</div>                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                    ...
                                    <tbody>
                                            ...
                                            <td style="padding-left: 120px;">
                                                <div class="tb-left" style="margin-bottom: 7px;">
                                                    ...
                                                    [상품명]                                                    <a href="detail.do?seq=${detail.qna_num }">[${detail.qna_subhead }] ${detail.qna_title }</a>
                                                                                                        <img src="image01/neo_new.gif" />                                                                                                    </div>
                                            </td>
                                            <td>
                                                <div class="tb-center">
                                                                                                                                                                    <div class='video-writer' style='padding-left:2px; padding-right:2px;' onMouseover="document.getElementById('MK_searchId_571893_00000').style.display='block'" onMouseout="document.getElementById('MK_searchId_571893_00000').style.display='none'">${detail.qna_author }                <div id='MK_searchId_571893_00000' class='search_id' style='display:none'>
                    <a href="Javascript:search_id('ahnjihunj')">회원게시글검색</a>
                </div></div>                                                                                                    </div>
                                            </td>
                                            <td><div class="tb-center">${detail.qna_writeday }</div></td>
                                            <td><div class="tb-center">${detail.qna_readCnt }</div></td>
                                        </tr>
                                                </tbody>
                                </table>
                            </div>
